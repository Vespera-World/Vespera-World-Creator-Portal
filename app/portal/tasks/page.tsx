...
import type { CreatorTask, CreatorPortalUser } from "@/lib/types/database"
...
export default async function TasksPage() {
  ...
  if (!user) {
    return <TasksClient tasks={[]} clientId="" isDemo />
  }
  ...
  const { data: tasks } = await supabase
    ...
    .order("due_date", { ascending: true, nullsFirst: false }) as { data: CreatorTask[] | null }
